...
function pickRandomGifts() {
  ...
  if (age == 1) {
    return gifts[1][
      `gift${Math.floor(Math.random() * Object.keys(gifts[1]).length) + 1}`
    ];
  } else if (age == 2) {
    return gifts[2][
      `gift${Math.floor(Math.random() * Object.keys(gifts[2]).length) + 1}`
    ];
  } else if (age >= 3 && age <= 6) {
    return gifts[6][
      `gift${Math.floor(Math.random() * Object.keys(gifts[6]).length) + 1}`
    ];
  } else if (age >= 7 && age <= 12) {
    return gifts[12][
      `gift${Math.floor(Math.random() * Object.keys(gifts[12]).length) + 1}`
    ];
  }
}
